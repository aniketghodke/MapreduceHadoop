...
public class PerMapTally {
	...
	public static class TokenizerMapper extends
		...
		public void map(Object key, Text value, Context context)
			...
			// Part 3 changes starts
			/* This is a per map approach so defining a hash map to store the 
			 * count of each word instead of emitting 1 for each word we will emit 
			 * the entire count in just one go*/
			HashMap<String, Integer> storageHash = new HashMap<String, Integer>();
			// Part 3 changes ends
			...
			// Part3 changes starts
			/* Instead of emitting 1 here we are giving the total count in that map task*/
